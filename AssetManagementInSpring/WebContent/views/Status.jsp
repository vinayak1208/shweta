...
<tr>
  <c:forEach var="status" items ="${status}">
	<td><c:out value=" ${status.allocationId}"></c:out></td>
	<td><c:out value=" ${status.assetId}"></c:out></td>
	<td><c:out value=" ${status.empNo}"></c:out></td>
	<td><c:out value=" ${status.status}"></c:out></td>
    </c:forEach> 
</tr>
